	...
	function add($formdata = null){
		if($formdata){
			...
			$this->rules_array = array(
				...
				'nik_siswa' => 'required|numeric|max_numeric,9999999999999999|min_numeric,1111111111111111',
				'tempat_lhr' => 'required',
				...
				'nama_ayah' => 'required',
				'nik_ayah' => 'required|numeric|max_numeric,9999999999999999|min_numeric,1111111111111111',
				'th_lhr_ayah' => 'required',
				'pendidikan_ayah' => 'required',
				'pekerjaan_ayah' => 'required',
				'penghasilan_ay' => 'required',
				'nama_ibu' => 'required',
				'nik_ibu' => 'required|numeric|max_numeric,9999999999999999|min_numeric,1111111111111111',
				'th_lhr_ibu' => 'required',
