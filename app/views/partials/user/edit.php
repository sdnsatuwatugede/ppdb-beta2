...
<section class="page" id="<?php echo $page_element_id; ?>" data-page-type="edit"  data-display-type="" data-page-url="<?php print_link($current_page); ?>">
    ...
    <div  class="bg-light p-3 mb-3">
        <div class="container">
            <div class="row ">
                <div class="col ">
                    <h4 class="record-title"><div class="custom-1">edit user</div></h4>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <input id="ctrl-nama_user"  value="<?php  echo $data['nama_user']; ?>" type="text" placeholder="Nama User"  required="" name="nama_user"  data-url="api/json/user_nama_user_value_exist/" data-loading-msg="Checking availability ..." data-available-msg="Available" data-unavailable-msg="Not available" class="form-control  ctrl-check-duplicate" />
