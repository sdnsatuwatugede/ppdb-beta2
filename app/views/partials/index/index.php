                ...
                <div class="row ">
                        ...
                        <div class="">
                            <div class="fadeIn animated mb-4">
                                <div class="text-capitalize">
                                    ...
                                    <p class="">Setelah register akan di arahkan kehalaman pengisian data siswa</p>
                                    <p class=""> <a href="<?php print_link("info/help") ?>">Pusat Bantuan</a></p>
                    ...
                    <div class="col-md-4 comp-grid">
                        ...
                        <div  class="background: rgb(131,58,180) p-3 animated fadeIn page-content">
                            <div>
                                <h5><i class="fa fa-key"></i> Masuk</h5>
                                <hr />
                                <?php 
                                ...
                                <form name="loginForm" action="<?php print_link('index/login/?csrf_token=' . Csrf::$token); ?>" class="needs-validation form page-form" method="post">
                                    ...
                                    <div class="text-center">
                                        Silakan Daftar di sini <a href="<?php print_link("index/register") ?>" class="btn btn-success">Daftar
