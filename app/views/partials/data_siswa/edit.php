                                                    ...
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <div id="ctrl-nik_siswa-holder" class=""> 
                                                                <input id="ctrl-nik_siswa"  value="<?php  echo $data['nik_siswa']; ?>" type="number" placeholder="Nik Siswa" min="1111111111111111" max="9999999999999999" step="1"  required="" name="nik_siswa"  class="form-control " />
                                                                </div>
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                                                        ...
                                                                                                        <div class="form-group col-md-6">
                                                                                                            ...
                                                                                                            <div class="form-group col-md-6">
                                                                                                                ...
                                                                                                                <div id="ctrl-nik_ayah-holder" class=""> 
                                                                                                                    <input id="ctrl-nik_ayah"  value="<?php  echo $data['nik_ayah']; ?>" type="number" placeholder="Nik Ayah" min="1111111111111111" max="9999999999999999" step="1"  required="" name="nik_ayah"  class="form-control " />
                                                                                                                    </div>
                                                                                                                </div>
                                                                                                                <div class="form-group col-md-6">
                                                                                                                ...
                                                                                                                <div class="form-group col-md-6">
                                                                                                                    ...
                                                                                                                    <div class="form-group col">
                                                                                                                        ...
                                                                                                                        <div id="ctrl-nik_ibu-holder" class=""> 
                                                                                                                            <input id="ctrl-nik_ibu"  value="<?php  echo $data['nik_ibu']; ?>" type="number" placeholder="Nik Ibu" min="1111111111111111" max="9999999999999999" step="1"  required="" name="nik_ibu"  class="form-control " />
                                                                                                                            </div>
                                                                                                                        </div>
                                                                                                                        <div class="form-group col-md-6">
